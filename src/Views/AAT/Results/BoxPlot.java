...
public class BoxPlot extends PApplet {
     ...
     * kunnen worden.
     */
    DesciptiveStatistics stat1;
    DesciptiveStatistics stat2;
    DesciptiveStatistics stat3;
    DesciptiveStatistics stat4;


    /**
     * @param model AATModel
     */
    public BoxPlot(AATModel model) {
        this.model = model;
        this.setLayout(null);
    ...
    private void calculate() {
        stat1 = Stats.getDescriptiveStatistics(labelsArray[0],array1);
        stat2 = Stats.getDescriptiveStatistics(labelsArray[1],array2);
        stat3 = Stats.getDescriptiveStatistics(labelsArray[2],array3);
        stat4 = Stats.getDescriptiveStatistics(labelsArray[3],array4);

        /**
         * minValue, q1, median, q3 en maxValue bevatten de respectievelijke de waarden uit de 4 condities
         */
        float minValue[] = {
                stat1.getMin(), stat2.getMin(), stat3.getMin(), stat4.getMin()
        };
        float q1[] = {
                stat1.getQ1(), stat2.getQ1(), stat3.getQ1(), stat4.getQ1()
        };
        float median[] = {
                stat1.getMedian(), stat2.getMedian(), stat3.getMedian(), stat4.getMedian()
        };
        float q3[] = {
                stat1.getQ3(), stat2.getQ3(), stat3.getQ3(), stat4.getQ3()
        };
        float maxValue[] = {
                stat1.getMax(), stat2.getMax(), stat3.getMax(), stat4.getMax()
        };
